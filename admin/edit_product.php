...
if(isset($_POST['sbm'])){
    ...
    if($_FILES['prd_image']==''){ $prd_img = $row['prd_image'];
    }else{
    ...
    $sql = "UPDATE product
     SET prd_name='$prd_name', prd_price='$prd_price', prd_warranty='$prd_warranty', prd_accessories='$prd_accessories', prd_promotion='$prd_promotion', prd_new='$prd_new', 
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input name="prd_featured" type="checkbox" <?php if($row['prd_featured']==1){ echo'checked';}else{
                                                echo 0;
                                            }  ?>   value=1>Nổi bật
                                        </label>
                                    </div>
