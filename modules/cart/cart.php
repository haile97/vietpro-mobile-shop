...
?>
    <div class="alert alert-danger" style="margin-top: 15px;">Hiện không có sản phẩm nào trong giỏ hàng !</div>
...
if (isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['mail']) && isset($_POST['add'])) {
    ...
    ';
    $str_body .= '
    <table border="1" cellspacing="0" cellpadđing="10" bordercolor="#305eb3" width="100%">
        <tr bgcolor="#305eb3">
    ...
    ';
    $str_body .= '<p>Cám ơn quý khách đã mua hàng tại shop của chúng tôi. Bộ phận giao hàng sẽ liên hệ với quý khách sau 5 phút kể từ khi quý khách đặt hàng thành công và chuyển đến quý khách chậm nhất sau 24h.</p>';
